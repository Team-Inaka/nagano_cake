...
class Costomers::CartItemsTest < ApplicationSystemTestCase
  setup do
    @costomers_cart_item = costomers_cart_items(:one)
  end

  test "visiting the index" do
    visit costomers_cart_items_url
    assert_selector "h1", text: "Costomers/Cart Items"
  end

  test "creating a Cart item" do
    visit costomers_cart_items_url
    click_on "New Costomers/Cart Item"
